...
import views.html._
/**/
object foot extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.Html] {
...
<p class="pull-right">Powered by: <a href="http://www.wilmartech.com/">康博嘉信息科技（上海）有限公司</a></p>"""))}
    ...
    def ref = this
                ...
                /*
                    ...
                    SOURCE: H:/play/play2/demoplay/app/views/foot.scala.html
