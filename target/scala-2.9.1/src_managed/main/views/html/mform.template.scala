...
import views.html._
/**/
object mform extends BaseScalaTemplate[play.api.templates.Html,Format[play.api.templates.Html]](play.api.templates.HtmlFormat) with play.api.templates.Template0[play.api.templates.Html] {
...
<head>
	...
	"""),_display_(Seq[Any](/*5.3*/css())),format.raw/*5.8*/("""
...
<body>
	...
	<div class="navbar">
		<div class="navbar-inner">
			"""),_display_(Seq[Any](/*13.5*/top())),format.raw/*13.10*/("""
		</div>
	</div>
	<!-- topbar ends -->
		...
		<div class="row-fluid">
			...
			<div class="span2 main-menu-span">
				<div class="well nav-collapse sidebar-nav">
					"""),_display_(Seq[Any](/*23.7*/menu())),format.raw/*23.13*/("""
				</div><!--/.well -->
			</div><!--/span-->
			<!-- left menu ends -->
	...
	"""),_display_(Seq[Any](/*395.3*/script())),format.raw/*395.11*/("""
...
"""))}
    ...
    def ref = this
                ...
                /*
                    ...
                    SOURCE: H:/play/play2/demoplay/app/views/mform.scala.html
                    HASH: bd40318648da482976a8a6843f851f88d4b7185c
                    MATRIX: 819->0|901->48|926->53|1069->161|1096->166|1365->400|1393->406|16487->15464|16518->15472
                    LINES: 30->1|34->5|34->5|42->13|42->13|52->23|52->23|424->395|424->395
                    -- GENERATED --
                */
